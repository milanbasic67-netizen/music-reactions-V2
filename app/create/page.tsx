...
function CreateContent() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-white flex flex-col items-center">
      ...
      {/* MODERAN HEADER */}
      <div className="sticky top-0 z-50 w-full bg-black/80 backdrop-blur-xl border-b border-zinc-800/50">
        <div className="max-w-[1200px] mx-auto flex justify-between items-center px-8 py-5">
          <h1 className="font-black text-2xl tracking-tighter uppercase italic text-red-600">Studio</h1>
          <div className="hidden lg:flex gap-8 text-sm font-bold uppercase tracking-widest">
            ...
            <button className="text-zinc-500 hover:text-white transition">Pomoć</button>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 w-full max-w-[1300px] flex flex-col lg:flex-row items-center justify-center gap-10 p-6 lg:p-16">
        ...
        <div className="w-full max-w-[420px] aspect-[9/16] bg-black rounded-[3rem] overflow-hidden border-8 border-zinc-900 shadow-[0_0_50px_rgba(0,0,0,0.5)] relative">
          <video
            id="song-video"
            src={videoUrl}
            controls
          ...
          />
          <div className="absolute top-6 left-6 z-10 bg-red-600 px-4 py-1.5 rounded-full shadow-lg">
          ...
          <div className="absolute bottom-10 left-8 right-8 z-10 pointer-events-none">
            ...
            <p className="text-zinc-400 text-sm font-medium">{artist}</p>
          </div>
        </div>
        ...
        <div className="w-full max-w-[420px] flex flex-col">
          ...
          <div className="bg-zinc-900/30 p-2 rounded-[3.5rem] border border-zinc-800/50 backdrop-blur-sm">
            <DuetRecorder
...
export default function CreatePage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-black flex items-center justify-center text-white font-black">UČITAVANJE STUDIJA...</div>}>
      <CreateContent />
    </Suspense>
  );
}